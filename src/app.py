...
activities = {
    ...
    "Basketball Club": {
        "description": "Practice dribbling, shooting, and play friendly games",
        "schedule": "Tuesdays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["maria@mergington.edu", "liam@mergington.edu"]
    },
    "Art Club": {
        "description": "Explore drawing, painting, and sculpture projects",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["chloe@mergington.edu", "sam@mergington.edu"]
    },
    "Drama Club": {
        "description": "Work on acting, stagecraft, and dramatic performances",
